...
const isInvalidValue = val => { 
    if (isNaN(val)) {
        console.error("Value is not a number"); //Changed console.log to console.error
    } else if (val <= 0) {
        console.error(`Value ${val} is not greater than zero.`);  //Changed console.log to console.error
    }
